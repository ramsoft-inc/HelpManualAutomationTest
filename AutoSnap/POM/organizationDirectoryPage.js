// const { TIMEOUT_IN_MSEC1, TIMEOUT_IN_MSEC2, TIMEOUT_IN_MSEC3 } = require('../common');
// const { sidebar } = require('../sidebar');
// const { orgDb } = require('./organizationDb');
...
class OrganizationDirectoryPage {
	constructor(page) {
		this.page = page;
...
module.exports = { OrganizationDirectoryPage };
