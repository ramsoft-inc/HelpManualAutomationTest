...
<table>
    ...
    <tbody>
        <tr class="odd">
            ...
            <td>Microsoft Windows 11 (64 Bit)</td>
        ...
        <tr class="even">
            ...
            <td>
                <p>500 GB SSD (for OS and cache)</p>
                <p></p>
            </td>
            <td>1 TB recommended (NVMe)</td>
        </tr>
        <tr class="odd">
...
To ensure that PHI (Protected Health Information) remains secure at all times, pixel data is encoded before being written to the local cache. This prevents unauthorized access to sensitive content stored on the device.

**Note**: The pixel data is encoded using the AES-GCM encryption algorithm, which provides both confidentiality and integrity protection.
