...
# Getting Started with Toolbar Customization in OmegaAI
...
OmegaAI’s Multimonitor setup extends the workspace across multiple screens for efficient access to viewers and tools.
 A detailed guide is available under the _**Organization Tools**_ section.
