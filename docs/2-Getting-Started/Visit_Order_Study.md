...
Users would be able to see all the Coverage added to the Patient.  
For each of the Coverage, the following Prior Authorization information can be added/updated:  
