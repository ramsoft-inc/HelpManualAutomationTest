...
## Save Measurements in Fusion Mode

- All ROI measurements performed in Fusion mode on the study can be
  automatically saved within the active session.

- Measurements taken in the Fusion Mode would remain preserved even
  after exiting the mode.

- When the same study is reopened in Fusion mode, the saved measurement
  details are displayed on both the image overlay and in the
  Measurements panel on the right.

![3](./img/Fusion_measurement.png)
