...
- **Yellow Line**: Coronal
 ...
 ## **Highlighted Viewport Interactions**

- When the user double-clicks on any viewport while in MPR Mode, that
viewport expands and renders in **Highlighted Mode** for focused
viewing.

- Double-clicking again on the same viewport exits the **Highlighted
Mode** and returns to the standard three-view layout.
